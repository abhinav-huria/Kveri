...
function SidebarOptions() {
  return (
    <div className="sidebarOptions">
      <a target="_blank" rel="noreferrer" href="https://medium.com/tag/history">
      ...
      <a
        target="_blank"
        rel="noreferrer"
        href="https://medium.com/tag/business"
      >
        <div className="sidebarOption">
          <img
      ...
      <a
        target="_blank"
        rel="noreferrer"
        href="https://medium.com/tag/psychology"
      >
        <div className="sidebarOption">
          <img
      ...
      <a target="_blank" rel="noreferrer" href="https://medium.com/tag/cooking">
        <div className="sidebarOption">
          <img
      ...
      <a target="_blank" rel="noreferrer" href="https://medium.com/tag/music">
        <div className="sidebarOption">
          <img
      ...
      <a target="_blank" rel="noreferrer" href="https://medium.com/tag/science">
        <div className="sidebarOption">
          <img
      ...
      <a target="_blank" rel="noreferrer" href="https://medium.com/tag/health">
        <div className="sidebarOption">
          <img
      ...
      <a target="_blank" rel="noreferrer" href="https://medium.com/tag/movies">
        <div className="sidebarOption">
          <img
      ...
      <a
        target="_blank"
        rel="noreferrer"
        href="https://medium.com/tag/education"
      >
        <div className="sidebarOption">
          <img
